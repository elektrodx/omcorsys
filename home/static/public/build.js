...
_react2['default'].render(_react2['default'].createElement(_componentsOrderTable2['default'], { orders: orders }), document.getElementById('container'));

},{"./components/OrderTable":4,"react":160}],2:[function(require,module,exports){
/*
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'td',
					null,
					this.props.orders.order_id
				),
				_react2['default'].createElement(
					'td',
					null,
					this.props.orders.customer
				),
				_react2['default'].createElement(
					'td',
					null,
					this.props.orders.date
				),
				_react2['default'].createElement(
					'td',
					null,
					this.props.orders.date_due
				),
				_react2['default'].createElement(
					'td',
					null,
					this.props.orders.weight
				),
				_react2['default'].createElement(
					'td',
					null,
...
var OrderTable = (function (_React$Component) {
  function OrderTable() {
    ...
    _get(Object.getPrototypeOf(OrderTable.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(OrderTable, [{
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_OrderList2['default'], { orders: this.props.orders })
      );
    }
  }]);
...
},{"./OrderHead":2,"./OrderList":3,"react":160}],5:[function(require,module,exports){
