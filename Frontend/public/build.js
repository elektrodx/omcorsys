...
var _componentsOrderTable = require('./components/OrderTable');

var _componentsOrderTable2 = _interopRequireDefault(_componentsOrderTable);

_react2['default'].render(_react2['default'].createElement(_componentsOrderTable2['default'], null), document.getElementById('container'));

},{"./components/OrderTable":5,"react":162}],2:[function(require,module,exports){
/*
...
var OrderHead = (function (_React$Component) {
	function OrderHead() {
		_classCallCheck(this, OrderHead);

		_get(Object.getPrototypeOf(OrderHead.prototype), 'constructor', this).apply(this, arguments);
	}

	_inherits(OrderHead, _React$Component);
...
var _OrderMap = require('./OrderMap');

var _OrderMap2 = _interopRequireDefault(_OrderMap);
		...
		value: function render() {
			...
			return _react2['default'].createElement(
				...
				this.props.orders.map(function (order) {
					return _react2['default'].createElement(_OrderMap2['default'], { key: _this.props.key, order: order });
				})
			);
		}
	}]);
...
},{"./OrderMap":4,"react":162}],4:[function(require,module,exports){
/*
 * Modules Dependencies
 */
...
var OrderMap = (function (_React$Component) {
	function OrderMap() {
		_classCallCheck(this, OrderMap);

		_get(Object.getPrototypeOf(OrderMap.prototype), 'constructor', this).apply(this, arguments);
	}

	_inherits(OrderMap, _React$Component);
	...
	_createClass(OrderMap, [{
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'td',
					{ className: 'order-date_due' },
					this.props.order.date_due
				),
				_react2['default'].createElement(
					'td',
					{ className: 'order-weight' },
...
var _OrderHead = require('./OrderHead');

var _OrderHead2 = _interopRequireDefault(_OrderHead);
...
var OrderTable = (function (_React$Component) {
  function OrderTable(props) {
    ...
    _get(Object.getPrototypeOf(OrderTable.prototype), 'constructor', this).call(this, props);
    this.state = { orders: [] };
  }
  ...
  _createClass(OrderTable, [{
    ...
    value: function componentDidMount() {
      ...
      $.get('http://localhost:8000/api/orders/?format=json', (function (result) {
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_OrderHead2['default'], null),
        _react2['default'].createElement(_OrderList2['default'], { key: this.state.orders.id, orders: this.state.orders })
      );
    }
  }]);
...
},{"./OrderHead":2,"./OrderList":3,"jquery":7,"react":162}],6:[function(require,module,exports){
